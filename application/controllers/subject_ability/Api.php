...
class Api extends CI_Controller
{
    ...
    public function add_school_unit()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_school_unit->add_once($data);
    ...
    public function edit_school_unit()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_school_unit->update_once($data['sn'], $data);
            $json_arr['sys_code'] = '200';
    ...
    public function get_once_school_unit()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_school_unit->get_once($data['sn']);
            $json_arr['sys_code'] = '200';
    ...
    public function remove_once_school_unit()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_school_unit->remove_once($data['sn']);
            $json_arr['sys_code'] = '200';
    ...
    public function add_staff()
    {
        ...
        if ($data == false) {
            ...
            if (!$this->mod_ability_staff->chk_once($data['member_code']) == true) {
                $this->mod_ability_staff->add_once($data);
                $json_arr['sys_code'] = '200';
                $json_arr['sys_msg'] = '資料新增完成';
            } else {
    ...
    public function edit_staff()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_staff->update_once($data['sn'], $data);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料編輯完成';
        }
        echo json_encode($json_arr);
    ...
    public function get_once_staff()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_staff->get_once($data['sn']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function remove_once_staff()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_staff->remove_once($data['sn']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '刪除成功';
        }
        echo json_encode($json_arr);
    ...
    public function add_task()
    {
        ...
        if ($data == false) {
            ...
            if (!$this->mod_ability_task->chk_once($data['job_code'])) {
                $this->mod_ability_task->add_once($data);
                $json_arr['sys_code'] = '200';
                $json_arr['sys_msg'] = '資料新增完成';
            } else {
                $json_arr['sys_code'] = '500';
    ...
    {
        $this->load->model('mod_ability_task');
        $getpost = array('sn', 'area', 'job_code', 'job_title', 'name', 'phone', 'note', 'day_count', 'one_day_salary', 'salary_total', 'lunch_price', 'lunch_total', 'total', 'order_meal', 'do_date', 'meal');
    ...
    public function get_once_task()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_task->get_once($data['sn']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function remove_once_task()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_task->remove_once($data['sn']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '刪除成功';
        }
        echo json_encode($json_arr);
    ...
    public function get_member_info()
    {
        ...
        $res = $this->mod_ability_task->get_member_info();
    ...
    public function assignment()
    {
        ...
        if ($data == false) {
            ...
            $count = $this->mod_ability_task->check_use_member_job($data['job_code'], $data['area']);
            // print_r($count);
            if ($count > 0) {
                $json_arr['sys_code'] = '000';
    ...
    public function add_fee()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_exam_fees->chk_once($year)) {
                $this->mod_ability_exam_fees->update_once($year, $data);
            } else {
                $this->mod_ability_exam_fees->add_once($data);
            }
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '儲存成功';
        }
    ...
    public function get_once_part()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_part_info->get_once($data['sn']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function save_part()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_part_info->update_once($data['sn'], $data);
            $json_arr['sys_code'] = '200';
    ...
    public function save_floor()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_part_info->update_floor($data);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料儲存完成';
        }
        echo json_encode($json_arr);
    ...
    public function save_addr()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_part_addr->chk_once($year)) {
                $this->mod_ability_part_addr->update_once($year, $data);
            } else {
                $this->mod_ability_part_addr->add_once($data);
            }
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '儲存成功';
        }
    ...
    public function get_part()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['part'] = $this->mod_ability_exam_area->get_part($data['part']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    function chk_trial_assigned()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_trial->chk_all_d($data['code'])) {
                $json_arr['sys_code'] = '500';
    ...
    public function remove_trial()
    {
        ...
        if ($data == false) {
            ...
            $data['year'] = $this->session->userdata('year');
            if ($this->mod_ability_trial->chk_once($data['sn'])) {
    ...
    {
        $this->load->model('mod_ability_trial');
        $getpost = array('sn', 'first_member_do_date', 'second_member_do_date', 'first_member_day_count', 'first_member_salary_section', 'first_member_section_salary_total', 'first_member_section_total', 'second_member_day_count', 'second_member_salary_section', 'second_member_section_salary_total', 'second_member_section_total');
        $requred = array('sn', 'first_member_day_count', 'first_member_salary_section', 'first_member_section_salary_total', 'first_member_section_total', 'second_member_day_count', 'second_member_salary_section', 'second_member_section_salary_total', 'second_member_section_total');
        $data = $this->getpost->getpost_array($getpost, $requred);
        //  print_r($data);
        if ($data == false) {
            $json_arr['sys_code'] = '000';
    ...
    public function get_max_filed()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['section'] = $this->mod_ability_exam_area->get_max_filed($data['start'], $data['end']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function add_trial_staff()
    {
        ...
        $requred = array('part', 'trial_staff_code', 'trial_staff_name', 'first_start', 'first_end', 'first_section', 'second_start', 'second_end', 'second_section', 'third_start', 'third_end', 'third_section', 'do_date');
        $data = $this->getpost->getpost_array($getpost, $requred);
        if ($data == false) {
            $json_arr['sys_code'] = '000';
            $json_arr['sys_msg'] = '資料不足';
            ...
            $data['year'] = $this->session->userdata('year');
            $member = $this->mod_ability_trial->get_once_trial_by_code($data['trial_staff_code']);
            ...
            $sql_data = array(
             ...
             // }else{
            $this->mod_ability_trial->add_trial($sql_data);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料新增完成';                
             // }
    ...
    public function save_trial_staff()
    {
        ...
        $requred = array('sn', 'part', 'trial_staff_code', 'trial_staff_name', 'first_start', 'first_end', 'first_section', 'second_start', 'second_end', 'second_section', 'third_start', 'third_end', 'third_section');
        $data = $this->getpost->getpost_array($getpost, $requred);
        if ($data == false) {
            $json_arr['sys_code'] = '000';
            $json_arr['sys_msg'] = '資料不足';
            ...
            $data['year'] = $this->session->userdata('year');
            if ($this->mod_ability_trial->chk_trial($data['sn'])) {
                $this->mod_ability_trial->update_trial($data['sn'], $data);
            } else {
                $this->mod_ability_trial->add_trial($data);
            }
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料儲存完成';
        }
    ...
    public function remove_trial_staff()
    {
        ...
        if ($data == false) {
            ...
            $data['year'] = $this->session->userdata('year');
            if ($this->mod_ability_trial->chk_trial($data['sn'])) {
                $this->mod_ability_trial->remove_trial_staff($data['sn']);
            } else {
                $json_arr['sys_code'] = '404';
    ...
    public function get_once_assign()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_trial->get_once_assign($data['sn']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function get_once_trial()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_trial->get_once_trial($data['sn']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function get_field_start_end()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['max'] = $this->mod_ability_trial->get_max_field($data['part']);
            $json_arr['min'] = $this->mod_ability_trial->get_min_field($data['part']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function add_patrol_staff()
    {
        ...
        if ($data == false) {
            ...
            $this->mod_ability_patrol->add_once($data);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料儲存完成';
        }
        echo json_encode($json_arr);
    ...
    public function save_patrol_staff()
    {
        ...
        if ($data == false) {
            ...
            $data['year'] = $this->session->userdata('year');
            $this->mod_ability_patrol->update_once($data['sn'], $data);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料儲存完成';
        }
        echo json_encode($json_arr);
    ...
    public function remove_patrol_staff()
    {
        ...
        if ($data == false) {
            ...
            $data['year'] = $this->session->userdata('year');
            $this->mod_ability_patrol->remove_patrol_staff($data['sn'], $data);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料刪除完成';
        }
        echo json_encode($json_arr);
    ...
    public function get_once_patrol()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_patrol->get_once($data['sn']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function get_patrol_list()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_patrol->get_patrol_list($data['part']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function get_staff_member()
    {
        ...
        if ($data == false) {
            ...
            $json_arr['info'] = $this->mod_ability_staff->get_staff_member($data['code']);
            $json_arr['sys_code'] = '200';
            $json_arr['sys_msg'] = '資料處理完成';
        }
        echo json_encode($json_arr);
    ...
    public function chk_part_list()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_trial->chk_part_list($data['part'], $data['area']) == true) {
                $json_arr['sys_code'] = '200';
    ...
    public function chk_list_for_voucher()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_trial->chk_list_for_voucher($data['part']) == true) {
                $json_arr['sys_code'] = '200';
                $json_arr['sys_msg'] = '匯出完成';
            } else {
                $json_arr['sys_code'] = '404';
    ...
    public function chk_task_list()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_task->chk_task_list($data['area']) == true) {
                $json_arr['sys_code'] = '200';
                $json_arr['sys_msg'] = '匯出完成';
            } else {
                $json_arr['sys_code'] = '404';
    ...
    public function chk_trial_staff_task_list()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_trial->chk_trial_staff_task_list($data['part']) == true) {
                $json_arr['sys_code'] = '200';
                $json_arr['sys_msg'] = '匯出完成';
            } else {
                $json_arr['sys_code'] = '404';
    ...
    public function chk_patrol_staff_task_list()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_trial->chk_patrol_staff_task_list($data['part']) == true) {
                $json_arr['sys_code'] = '200';
                $json_arr['sys_msg'] = '匯出完成';
            } else {
                $json_arr['sys_code'] = '404';
    ...
    public function chk_supervisor_list()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_trial->chk_supervisor_list($data['part']) == true) {
                if ($this->mod_ability_trial->chk_patrol_member($data['part']) == true) {
                    $json_arr['sys_code'] = '200';
                    $json_arr['sys_msg'] = '匯出完成';
                } else {
                    $json_arr['sys_code'] = '404';
    ...
    public function chk_part_list_of_obs()
    {
        ...
        if ($data == false) {
            ...
            if ($this->mod_ability_trial->chk_part_list_of_obs($data['part'], $data['area'], $data['obs']) == true) {
                $json_arr['sys_code'] = '200';
                $json_arr['sys_msg'] = '匯出完成';
            } else {
                $json_arr['sys_code'] = '404';
