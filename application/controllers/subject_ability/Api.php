     ...
     */
     function chk_trial_assigned(){
         ...
         if ($data == false) {
             ...
             if($this->mod_ability_trial->chk_trial_assigned($data['code'])){
                 $json_arr['sys_code'] = '500';
