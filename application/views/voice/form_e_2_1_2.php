...
<table class="" id="" style="padding:5px 0px;;text-align:center;">
    <tr>
        <td style="font-size:26px;lne-height:50px;" colspan="6"><?=$_SESSION['year']?>學年度高中英語能力測驗新北一考區試務人員簽到表</td>
    </tr>
    <tr>
    ...
    ?>
    <tr>
        <td colspan="7" style="font-size:16px;text-align:left;">共計：<?=count($v)?>人、自備：<?=$own_count?>人、素食：<?=$veg_count?>人、葷食：<?=$meat_count?>人</td>
    </tr>
</table>
<?php endforeach; ?>
