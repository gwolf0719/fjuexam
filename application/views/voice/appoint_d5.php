    ...
    <div class="row boxs">
        <div class="col-md-12 col-sm-12 col-xs-12 " style="margin: 50px auto 0px;">
            <form method="POST" enctype="multipart/form-data" action="" id="form" class="">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube W14">
                    <p style="text-align:center" value='<?=$datetime_info['day'];?>'>上午場<?=$datetime_info['day']; ?></p>
                    <div class="form-group">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube W14">
                    ...
                    <div class="form-group" style="padding: 0% 3%;">
                        <div class="W50">
                            ...
                            <input type="text" class="form-control" id="one_day_salary" style="display:none" value="<?=$fees_info['pay_2']; ?>">
                            <input type="text" class="form-control" id="salary_section" value="<?=$fees_info['pay_2']; ?>">
                        </div>
                        <div class="W50">
