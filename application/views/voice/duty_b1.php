...
$(function() {
    ...
    $("body").on("click", "#send", function() {
        if (confirm("確定儲存修改資料？")) {
            ...
            var do_date;
            $.each($("input[id='do_date']:checked"), function() {
                do_date = $(this).val();
            });
...
<div class="row">
    <div class="p-2 " style="width:300px;">
        <div class="input-group">
            ...
            <input type="text" class="form-control" value="<?= $this->session->userdata('year'); ?>" style="width:60px;"
                readonly>
            <input type="text" class="form-control" value="<?= $this->session->userdata('ladder'); ?>"
    ...
    <div class="row boxs">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="margin:20px 0px 20px 25px">
            <div class="row">
                ...
                <div class="col-6">
                    <button type="button" class="btn btn-primary" id="assign" data-toggle="modal"
                        data-target="#exampleModal" style="display:none;">指派</button>
            ...
            <form method="POST" enctype="multipart/form-data" action="" id="form" class="">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube">
                    <div class="form-group">
                        ...
                        <input type="checkbox" class="chbox" id="do_date" name="day" value=<?= $datatime_info['day']; ?>
                            checked>
                        <span class="chbox">
                            <?= $datatime_info['day']; ?>
                        </span>
                    ...
                    <div class="">
                        <div class="">
                            <label for="note" class=""
                                style="float:left;text-align:left;width: 8%;text-align:center;">備註</label>
