...
<table class="" id="" style="text-align:center;">
    <thead>
        <tr>
            <td colspan="7" style="font-size:26px;font-family: serif,cursive;">
                <?= $_SESSION['year'] ?>學年度英語聽力測驗<?= $_SESSION['ladder'] ?>考試新北一考區</td>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <td colspan="11" style="text-align:left;font-size:18px;font-weight:bold">共計:<?= $member_count ?>人
            實發監考費：<?= number_format($money_count) ?> = 總支出費用<?= number_format($money_count) ?> </td>
    </tr>
</table>