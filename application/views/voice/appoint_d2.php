...
<div class="row">
    <div class="input-group col-sm-2">
        ...
        <input type="text" class="form-control" id="ladder" value="<?= $this->session->userdata('ladder'); ?>"
            ...
            <form method="POST" enctype="multipart/form-data" action="" id="form" class="">
                <div class="col-md-3 col-sm-3 col-xs-3 cube" style="background:#afccf0">
                    <div class="form-group" style="width: 100%;float: left;">
                        ...
                        <input type="hidden" class="form-control" id="allocation_code" style="width: 28%;float: left;"
                            placeholder="">
                        <input type="hidden" class="form-control" id="part" style="" placeholder="" value="2501">
                        <input type="text" class="form-control" id="trial_staff_code" style="width: 25%;float: left;"
                            placeholder="管卷人員編號">
                        <input type="text" class="form-control" id="trial_staff_name"
                            style="width: 24%;float: left;margin-left: 5px;">
                        <button type="button" class="btn btn-primary assgin" data-toggle="modal"
                            data-target="#exampleModal"
                            style="float:left;width:20%;margin-left:5px;background:#346a90;border:unset">指派</button>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-3 cube" style="max-width: 20%; " id="morning_field"
                    date='<?= $datetime_info['day']; ?>'>
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control day" id="first_section" value="0" readonly
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube" style="max-width: 20%; " id="aftermorning_field">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control day" id="second_section" value="0" readonly
                            day="<?= mb_substr($datetime_info['day'], 5, 8, 'utf-8'); ?>">
                    </div>
                </div>
                <div class="">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6 " style="float:left;margin: 20px auto;">
            <div class="">
                <div class="">
                    ...
                    <textarea name="note" id="note" class="" style="width:460px"></textarea>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-6" style="float:left;margin: 20px auto;">
