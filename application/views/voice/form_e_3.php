...
<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 cube text-center">
        <img src="assets/images/e_3_1.png" alt="" style="cursor: pointer;-webkit-filter:grayscale(1);">
    </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="btn_part btn2" link="./voice/e/form_e_3_1?part=2501&area=第一分區" part="2501" area="第一分區">第一分區</div>
                        <div class="btn_part btn2" link="./voice/e/form_e_3_1?part=2502&area=第二分區" part="2502" area="第二分區">第二分區</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="btn_part btn1" link="./voice/e/form_e_3_2_1?part=2501&area=第一分區&date=<?=mb_substr($datetime_info['day'], 5, 8, 'utf-8'); ?>" part="2501" area="第一分區"><?=mb_substr($datetime_info['day'], 5, 8, 'utf-8'); ?></div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="btn_part btn1" link="./voice/e/form_e_3_2_2?part=2502&area=第二分區&date=<?=mb_substr($datetime_info['day'], 5, 8, 'utf-8'); ?>" part="2502" area="第二分區"><?=mb_substr($datetime_info['day'], 5, 8, 'utf-8'); ?></div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="btn_part btn1" link="./voice/e/form_e_3_2_3?part=2503&area=第三分區&date=<?=mb_substr($datetime_info['day'], 5, 8, 'utf-8'); ?>" part="2503" area="第三分區"><?=mb_substr($datetime_info['day'], 5, 8, 'utf-8'); ?></div>
