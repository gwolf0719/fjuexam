...
$(function() {
    ...
    $("body").on("click", "tr", function() {
        ...
        $("#supervisor_1").val($(this).find('td').eq(4).text().trim());
        $("#supervisor_2").val($(this).find('td').eq(6).text().trim());
        ...
        <table class="table table-hover" id="">
            ...
            <tbody>
                ...
                <tr sn="<?= $v['sn']; ?>" part="2501" field="<?= $v['field'] ?>" block_name='<?= $v['block_name'] ?>'
                    supervisor_1_code="<?= $v['supervisor_1_code'] ?>"
                    supervisor_2_code="<?= $v['supervisor_2_code'] ?>">
                    <td><?= $k + 1; ?></td>
                    <td><?= $v['field']; ?></td>
                    <td><?= $v['floor']; ?></td>
                ...
                <div style=width:100%;float:left;>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 cube" style="background:#afccf0">
                        <div class="form-group" style="width: 100%;float: left;">
                            ...
                            <input type="text" class="form-control" id="trial_staff_code_1"
                                style="width: 25%;margin: 0px 4px;float: left;" placeholder="監試人員編號" readonly>
                        ...
                        <div class="form-group" style="width: 100%;float: left;">
                            ...
                            <input type="text" class="form-control" id="trial_staff_code_2"
                                style="width: 25%;margin: 0px 4px;float: left;" placeholder="監試人員編號" readonly>
...
<!-- Modal end-->
<!-- Modal start-->
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="border-bottom: none;">
