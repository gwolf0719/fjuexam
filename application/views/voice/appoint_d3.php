            ...
            <form method="POST" enctype="multipart/form-data" action="" id="form" class="">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube" style="background:#afccf0">
                    <div class="form-group" style="width: 100%;float: left;">
                        ...
                        <input type="hidden" class="form-control" id="allocation_code" style="width: 25%;float: left;"
                            placeholder="">
                        <input type="text" class="form-control" id="patrol_staff_code" style="width: 25%;float: left;"
                            placeholder="巡場人員編號">
