...
<div class="W80" style="text-align: left;padding-left: 6%;">
    ...
    <img src="assets/images/e_5_2.png" alt="" style="width: 30%;">
</div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <a href="./voice/e/form_e_5_2_1" target="_blank">
                            <div class="btn_part">監試人員</div>
                        </a>
                        <a href="./voice/e/form_e_5_2_2" target="_blank">
                            <div class="btn_part">試務人員</div>
                        </a>
                        <a href="./voice/e/form_e_5_2_3" target="_blank">
                            <div class="btn_part">管卷人員</div>
                        </a>                                                
                        <a href="./voice/e/form_e_5_2_4" target="_blank">
