    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="btn_part btn3" link="./voice/e/form_e_7_3?part=2501&area=0" part="2500" area="0">考區</div>
                        <div class="btn_part btn3" link="./voice/e/form_e_7_3?part=2501&area=1" part="2501" area="1">第一分區</div>
                        <div class="btn_part btn3" link="./voice/e/form_e_7_3?part=2502&area=2" part="2502" area="2">第二分區</div>  
                        <div class="btn_part btn3" link="./voice/e/form_e_7_3?part=2503&area=3" part="2503" area="3">第三分區</div> 
                    </div>
                </div>
            </div>
        </div>
