...
<div class="row">
    ...
    <div class="col-sm-8" style="text-align: center;">
        <img src="assets/images/b7_title.png" alt="" style="width: 20%;">
    </div>
...
<div class="row" style="position: relative;top: 20px;left: 10px;">
    <div style="width:95%;margin:0 auto">
        ...
        <div class="tab" area="5">
            <div class="W50 ball">B5</div>
            <div class="W50 tab_text">第四分區</div>
        </div>
        <div class="tab" area="6">
            <div class="W50 ball">B6</div>
            <div class="W50 tab_text">第五分區</div>
        </div>
    </div>
</div>
