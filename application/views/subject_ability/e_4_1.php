...
<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 cube text-center">
        <img src="assets/images/e_4_1_1.png" alt="" style="cursor: pointer;" data-toggle="modal" data-target="#download">
    </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <a href="./subject_ability/e_4_1_1" target="_blank">
                            <div class="btn_part">監試人員</div>
                        </a>
                        <a href="./subject_ability/e_4_1_2" target="_blank">
                            <div class="btn_part">試務人員</div>
                        </a>
                        <a href="./subject_ability/e_4_1_3" target="_blank">
                            <div class="btn_part">管卷人員</div>
                        </a>   
                        <a href="./subject_ability/e_4_1_4" target="_blank">
