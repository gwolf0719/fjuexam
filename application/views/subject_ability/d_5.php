...
$(function() {
    ...
    $("body").on("click", "tr", function() {
        ...
        $.ajax({
            ...
            var section_count = parseInt(data.info.first_section) + parseInt(data.info
                .second_section) + parseInt(data.info.third_section);
            var day_arr = [data.info.first_section, data.info.second_section, data.info
                .third_section
            ];
            ...
            switch (data.info.calculation) {
                case "by_section":
                    ...
                    var section_lunch_total = data.info.lunch_total;
                ...
                case "":
                    ...
                    if (data.info.order_meal.toUpperCase() == "N" || data.info.order_meal ==
                        ...
                        $("#lunch_price").attr("readonly", true);
                        var section_salary_total = parseInt($("#salary_section").val()) *
                            parseInt($("#section_count").val());
                        $("#section_salary_total").val(section_salary_total);
                        var section_lunch_total = $("#section_lunch_total").val();
                        var section_total = section_salary_total - section_lunch_total;
                        $("#section_total").val(section_total);
                    } else {
                        $("#order_meal").prop("checked", true);
    ...
    $("body").on("keyup", "#one_day_salary", function() {
        ...
        if ($("#order_meal").val() == "N") {
            ...
            var day_lunch_total = $("#day_lunch_total").val();
    ...
    $("body").on("change", "#order_meal", function() {
        if ($(this).prop("checked") == false) {
            ...
            var day_lunch_total = parseInt($("#lunch_price").val()) * parseInt($("#lunch").val());
    ...
    $("body").on("change", "#calculation", function() {
        if ($("#calculation").val() == "by_section") {
            ...
            if ($("#order_meal").prop("checked") == false) {
                ...
                var section_salary_total = parseInt($("#salary_section").val()) * parseInt($(
                    "#section_count").val());
                var section_lunch_total = parseInt($("#lunch_price").val()) * parseInt($(
                    "#lunch").val());
                $("#section_lunch_total").val(section_lunch_total);
                var section_total = section_salary_total - section_lunch_total;
                $("#section_total").val(section_total);
                ...
                var day_salary_total = parseInt($("#one_day_salary").val()) * parseInt($(
                    "#day_count").val());
                var day_lunch_total = parseInt($("#lunch_price").val()) * parseInt($(
                    "#lunch").val());
                $("#day_lunch_total").val(day_lunch_total);
                var day_total = day_salary_total - day_lunch_total;
                $("#day_total").val(day_total);
            ...
            var day_salary_total = parseInt($("#day_count").val()) * parseInt($("#one_day_salary")
                .val())
            $("#day_salary_total").val(day_salary_total)
            if ($("#order_meal").prop("checked") == false) {
                $("#day_total").val($("#day_salary_total").val());
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 50px auto 0px;">
            <form method="POST" enctype="multipart/form-data" action="" id="form" class="">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube W14">
                    ...
                    <div class="form-group">
                        <label for="trial_end" class="" style="float:left;font-size: 12px">最大節數</label>
                        <input type="text" class="form-control day" id="third_section" readonly
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube W20">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="display:none;font-size: 12px" id="day_count"
                            readonly value="0">
                    ...
                    <div class="form-group" style="padding: 0% 3%;">
                        ...
                        <div class="W50">
                            ...
                            <input type="text" class="form-control" id="day_salary_total"
                                style="display:none;width: 50%;" value="0" readonly>
                    ...
                    <div class="form-group" style="padding: 0% 3%;">
                        <div class="W50">
                            ...
                            <input type="text" class="form-control" id="lunch_price" value="0" lunch_price="" disabled>
                        </div>
                        <div class="W50">
                            <label for="trial_start" class="" style="float:left;width: 50%;font-size: 12px">便當總計</label>
                            <input type="text" class="form-control" id="day_lunch_total" style="display:none" value="0"
                                readonly>
