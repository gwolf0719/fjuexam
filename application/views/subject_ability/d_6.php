...
$(function() {
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                if ($("#order_meal").val() == "N") {
                    ...
                    var day_lunch_total = $("#section_lunch_total").val();
    ...
    $("body").on("change", "#order_meal", function() {
        if ($(this).prop("checked") == false) {
            ...
            $("#section_total").val(section_total);
            // 天數
            var day_salary_total = parseInt($("#one_day_salary").val()) * parseInt($("#day_count")
                .val());
            var day_lunch_total = 0 - parseInt($("#lunch_price").val()) * parseInt($("#day_count")
                .val());
            $("#day_lunch_total").val(day_lunch_total);
            ...
            <form method="POST" enctype="multipart/form-data" action="" id="form" class="">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube">
                    <div class="form-group">
                        ...
                        <input type="checkbox" class="chbox as" id="" name="day"
                    ...
                    <div class="form-group" style="padding: 0% 3%;">
                        <div class="W50">
                            ...
                            <input type="text" class="form-control" id="lunch_price" value="0"
                                lunch_price="<?= $fees_info['lunch_fee']; ?>" disabled>
                        </div>
                        <div class="W50">
