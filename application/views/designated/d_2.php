...
$(function() {
    ...
    $("body").on("click", "#send", function() {
        if (confirm("是否要儲存?")) {
            ...
            var count = parseInt(first_section) + parseInt(second_section) + parseInt(third_section);
            console.log(sn);
            $.ajax({
            ...
            <form method="POST" enctype="multipart/form-data" action="" id="form" class="">
                <div class="col-md-3 col-sm-3 col-xs-3 cube" style="background:#afccf0">
                    <div class="form-group" style="width: 100%;float: left;">
                        ...
                        <input type="text" class="form-control" id="allocation_code" style="width: 28%;float: left;"
                            placeholder="管卷人員編號">
                        <input type="hidden" class="form-control" id="part" style="" placeholder="" value="2501">
                        <input type="hidden" class="form-control" id="trial_staff_code" style="width: 20%;float: left;"
                            placeholder="">
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube" style="max-width: 20%;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control day" id="first_section" value="0" readonly
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube" style="max-width: 20%;">
                    ...
                    <div class="form-group">
                        <label for="start" class="" style="float:left;">節數</label>
                        <input type="text" class="form-control day" id="second_section" value="0" readonly
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 cube" style="max-width: 20%;">
                    ...
                    <div class="form-group">
                        <label for="start" class="" style="float:left;">節數</label>
                        <input type="text" class="form-control day" id="third_section" value="0" readonly
