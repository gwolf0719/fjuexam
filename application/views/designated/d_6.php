...
$(function() {
    ...
    $("body").on("keyup", "#one_day_salary", function() {
        ...
        if ($("#order_meal").val() == "N") {
            ...
            var day_lunch_total = parseInt($("#lunch_price").val()) * parseInt($("#day_count")
                .val());
            $("#day_lunch_total").val(day_lunch_total);
            var day_total = day_salary_total - day_lunch_total;
            $("#day_total").val(day_total);
    ...
    $("body").on("keyup", "#salary_section", function() {
        ...
        if ($("#order_meal").val() == "N") {
            ...
            //     "#day_count").val());
            $lunch = $("#section_lunch_total").val();
            var section_total = section_salary_total - $lunch;
                    ...
                    <div class="form-group" style="padding: 0% 3%;">
                        <div class="W50">
                            ...
                            <input type="text" class="form-control" id="lunch_price" value="0"
                                lunch_price="<?= $fees_info['lunch_fee']; ?>" readonly>
                        </div>
                        <div class="W50">
