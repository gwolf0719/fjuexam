...
<table class="" id="" style="padding:4px;text-align:center;">
    <thead>
        <tr>
            <td colspan="13" style="font-size:22px;">請公假名單</td>
        </tr>
        <tr>
            <td colspan="13" style="text-align:right;font-size:18px;">印表日期：<?=(date("Y") - 1911).date("/m/d")?></td>
        </tr>
        ...
        <?php endforeach; ?>
        <tr>
            <td colspan="13" style="font-size:14px;text-align:left;">共計：<?=count($list)?>人</td>
        </tr>  
</table>