...
$(function() {
    ...
    $("body").on("click", "tr", function() {
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                console.log(day.day);
                // 監試人員一天數
                $('input:checkbox[name="first_member_day"]').eq(0).prop("checked", day
                    .day[0]);
                $('input:checkbox[name="first_member_day"]').eq(1).prop("checked", day
                    .day[1]);
                $('input:checkbox[name="first_member_day"]').eq(2).prop("checked", day
                    .day[2]);
                // 監試人員二天數
                $('input:checkbox[name="second_member_day"]').eq(0).prop("checked", day
                    .day[0]);
                $('input:checkbox[name="second_member_day"]').eq(1).prop("checked", day
                    .day[1]);
                $('input:checkbox[name="second_member_day"]').eq(2).prop("checked", day
                    .day[2]);
            })
        })
    })
    ...
    $("body").on("keyup", "#first_member_lunch_price", function() {
        var lunch_total = $(this).val() * $("#first_member_day_count").val();
    ...
    $("body").on("keyup", "#second_member_lunch_price", function() {
        var lunch_total = $(this).val() * $("#second_member_day_count").val();
            ...
            <form method="POST" enctype="multipart/form-data" action="" id="form" class="">
                <div style="width:50%;float:left">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 cube W14">
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="checkbox" class="chbox" id="" name="first_member_day"
                ...
                <div style="width:50%;float:left;padding-left:30px;border-left: 1px solid #000;">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 cube W14">
                        ...
                        <div class="form-group">
                            <label for="start_date" class="" style="float:left;">執行日</label>
                            <input disabled type="checkbox" class="chbox" id="" name="second_member_day"
                                value="<?= mb_substr($datetime_info['day_1'], 5, 8, 'utf-8'); ?>">
                            <span class="chbox">
                                <?= mb_substr($datetime_info['day_1'], 5, 8, 'utf-8'); ?>
                            </span>
